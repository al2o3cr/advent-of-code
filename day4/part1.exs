...
{sleepy_guard, days} =
  days_by_guard
  |> Enum.max_by(&(GuardSleeping.count_sleeps(elem(&1, 1))))

common_time = GuardSleeping.most_common_sleep(days)

IO.puts "Guard #{sleepy_guard}, minute #{common_time}"
